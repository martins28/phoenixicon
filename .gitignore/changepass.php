...
<html lang="en">
  <head>
    ...
    <title>PhoenixIcon | Change Password</title>
    <!-- Bootstrap -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span6 offset3">
            <h4 class="widget-header"><i class="icon-lock"></i> Change Password</h4>
            <div class="widget-body">
              <div class="center-align">
                <form class="form-horizontal form-signin-signup" action="passchange.php" method="POST">
