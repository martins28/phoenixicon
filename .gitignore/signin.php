...
<html lang="en">
  <head>
    ...
    <title>PhoenixIcon | Sign In Here</title>
    <!-- Bootstrap -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="span6 offset3">
            <h4 class="widget-header"><i class="icon-lock"></i> Signin to View Your Account</h4>
            <div class="widget-body">
              <div class="center-align">
                <form class="form-horizontal form-signin-signup" action="loginprocess.php" method="POST">
                ...
                <div>
                <i class="icon-question-sign"></i><a href="passwordrecovery.php">Forgot Password</a>
              </div>
              </div>
